...
function App() {
    ...
    <div className="row ">
        <div className="col-md-12">
            <div className="panel panel-default login" id="main" style = {{left:360, top:20}}>
                ...
                <div className="panel-body">
                    ...
                    setPasswordLog(e.target.value);
                            ...
                            <div  className="buttons">
                             <a href="/fac_acad"> <button type="submit" className="btn btn-primary" style={{width: 300, height: 50}}  >Sign in</button> </a>
                            </div>
                    </div>
                </div>
